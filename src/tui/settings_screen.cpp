...
ftxui::Component SettingsScreen::buildSettingsView() {
    ...
    auto renderer = ftxui::Renderer(std::function<ftxui::Element()>([self] {
        ...
        auto lines = ftxui::vbox({
            ftxui::text("=== General Settings ===") | ftxui::bold,
            ...
            ftxui::text(""),
            ftxui::text("=== Build Settings ===") | ftxui::bold,
            ...
            ftxui::text(""),
            ftxui::text("=== Editor Settings ===") | ftxui::bold,
...
bool SettingsScreen::onEvent(ftxui::Event event) {
    if (event == ftxui::Event::Character('q') ||
        event == ftxui::Event::Escape) {
        return true; // handled by the CatchEvent in Application
    }
    return false;
}
